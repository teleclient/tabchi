 ...
 * Tabchi v1.0.0 Async
 *
 * @author SudoSoldier <https://t.me/SudoSoldier>
 * @author Madeline Farsi And Samy & Saman : <https://t.me/Madeline_Farsi>
 * @author ZiroSource : <https://t.me/ZiroSource>
 *
...
$MadelineProto = new API('SudoSoldier.madeline', $settings);
...
##---------------Event Handler----------------##
class SudoSoldier extends EventHandler
{
    /**
    ...
    public function onUpdateNewMessage(array $update): \Generator
    {
        ...
        if (isset($update['message']['message'])) {
            ...
            $SudoSoldier = '<a href="mention:@SudoSoldier">SudoSoldier</a>';
            $SudoSoldier = '<a href="mention:@SudoSoldier">SudoSoldier</a>';
            $me          = $this->getSelf();
            $me_id       = $me['id'];
            $sudo        = $GLOBALS['dev'];
            ...
            try {
                ...
                if ($userID === $sudo or isset($data['data']['Admins'][$userID])) {
                    ...
                    if (in_array($msg, ['state', 'vaziat', 'آنلاین✅', 'ربات', 'آنلاین', 'پینگ'])) {
                        $text = "ربات $state است." . PHP_EOL . "$SudoSoldier";
                        yield $this->messages->sendMessage(['peer' => $chatID, 'parse_mode' => 'html', 'message' => $text, 'reply_to_msg_id' => $msg_id]);
                    }
                    ##==========================SETTINGS==========================##
                    if ($state === "آنلاین✅") {
           ...
           ", 'parse_mode' => 'markdown']);
            ...
            ", 'parse_mode' => 'html']);
                        ...
                        if (preg_match("/^[#!\/]?(profile) /i", $msg)) {
                            ...
                            $id1 = (isset($mch[2]) && $mch[2] !== "" && $mch[2] !== " ") ? $mch[2] : "SudoSoldier";
                            $id2 = (isset($mch[3])) ? $mch[3] : "";
                            $id3 = (isset($mch[4]) && $mch[4] !== "" && $mch[4] !== " ") ? $mch[4] : "@SudoSoldier | PHP Developer";
...
$MadelineProto->startAndLoop(SudoSoldier::class);